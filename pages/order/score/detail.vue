	...
	<view>
		...
		<view class="container">
			...
			<view class="order-info-box">
				...
				<view class="info-list" v-if="orderAddress && order.orderStatus!==302">
			...
			<view class="info-list" v-if="order.orderStatus===302">
				<view class="fs-24 lh-34 fc-303">订单情况</view>
				<view class="fs-24 lh-34 fc-303">已委托</view>
			</view>
			</view>
		...
		<!-- tabbar 占位 -->
		<view style="height: (50px + env(safe-area-inset-bottom) / 2);min-height: 100v-elserpx;"></view>
		<view class="cu-bar bg-white tabbar border order-box">
		
			<view v-if="order.orderStatus == 100">
				<button class="cu-btn line-btn fc-303 round ml24" @click="showAddress=true">发货</button>
				<button class="cu-btn line-btn fc-303 round ml24" @click="goToPP">转卖</button>
			</view>
		
			<button v-else class="cu-btn line-btn fc-303 round ml24" @click="showCustomer">联系商家</button>
			<!-- 待支付订单的按钮 -->
