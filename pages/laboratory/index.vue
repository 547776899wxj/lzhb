<template>
	<view  id="containerId">
		...
		<!-- 搜索框 -->
		<view class="flex-center pl24 pr24 invite-box">
			<!-- <image src="/static/img/icon/goods-icon@2x.png" mode="" class="goods-icon mr26"></image> -->
			<!-- <image src="/static/img/icon/gd.png" mode="" class="back-icon trans180 mr26" @click.stop="back()"></image> -->
		...
		<view>
			<view class="goods-navlist dflex ac pl16 pr160">
				<view class="dflex fs-0">
					<view class="goods-nav cur">全部
