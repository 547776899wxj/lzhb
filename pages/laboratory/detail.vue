	...
	<view class="goods-detail">
		...
		<view class="cu-bar bg-white border shop">
			<button class="action" open-type="contact" @click.stop="showCustomer()">
				<image class="m-icon" src="../../static/img/icon/kefu.png"></image> 客服
			</button>
			<view class="btn-group">
				...
				<button class="cu-btn bg-pp fc-f round" v-else @click="showBuyDialog=true">立即购买</button>
			</view>
		</view>
		<customer :show="customerAlert" @cancel="hideModel"></customer>
			<buyWelfare :show="showBuyDialog" :buyGoods="goodsDetail"  @close="showBuyDialog=false"></buyWelfare>
	</view>
</template>
