<template>
	<view>
			<cu-custom bgColor="bg-f6" :isBack="true">
				...
				<block slot="content">物品转卖记录</block>
			</cu-custom>
			...
			<view class="flex-between ac bc-f">
				...
				<view class="order-nav" :class="queryObj.auctionLotHangupStatus==2?'cur':''" @click="queryObj.auctionLotHangupStatus=2,getAuctionLots()">转卖中 <view class="cur-icon"></view></view>
				<view class="order-nav" :class="queryObj.auctionLotHangupStatus==4?'cur':''" @click="queryObj.auctionLotHangupStatus=4,getAuctionLots()">已卖出 <view class="cur-icon"></view></view>
				<view class="order-nav" :class="queryObj.auctionLotHangupStatus==3?'cur':''" @click="queryObj.auctionLotHangupStatus=3,getAuctionLots()">未卖出 <view class="cur-icon"></view></view>
			</view>
						...
						<view class="goods-info dflex ai-fs mb16">
							...
							<view class="flex-1">
								...
								<view class="dflex ac tr">
									<view class="fs-24 lh-24 fc-939">买入价：</view>
