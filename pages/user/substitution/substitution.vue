		...
		<view class="container">
			<view class="bc-f bri-20 mb20">
				<view class="flex-between ac pt20 pl20 pr20">
					<view class="fs-24 lh-34 fc-303">买入时间  {{lotObj.lotInTime}}</view>
				...
				<view class="goods-info">
					...
					<view class="wp100 goods-msg flex-between fdc">
						<view class="dflex fdc jc-fs">
							...
							<view class="fs-20 lh-28 fc-939">物品编号 {{lotObj.lotId}}</view>
						</view>
			...
			<view class="auction-price-box">
				...
				<view class="fs-24 lh-34 fc-939">1.仅支持3000以上非留下自用物品</view>
				<view class="fs-24 lh-34 fc-939">2.置换物品需消耗一张置换券</view>
				<view class="fs-24 lh-34 fc-939">3.如果物品状态为申请挂卖，则会自动取消挂卖，挂卖申请佣金会自动返还零钱账户</view>
