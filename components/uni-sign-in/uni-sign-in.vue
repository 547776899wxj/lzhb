		...
		<uni-popup ref="popup" type="center">
			...
			<view class="content">
				<view class="main">
					...
					<text class="total" style="margin-top: 20px;">本轮已签到{{signInRes.days.length}}天</text>
				...
				<view>
					...
					<view class="tip-box">
						...
						<view class="row">
							...
							<!-- <text class="red">30</text>
							<text class="tip">元抵用券</text> -->
						</view>
					</view>
				</view>
		...
		methods: {
			...
			async open() {
				...
				try{
					...
					// let res = this.signInRes;
					if (this.signInRes.data) {
						uni.hideLoading()
						uni.showToast({
							title: '今日已签过',
							duration: 3000,
