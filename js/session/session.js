...
export const getOpenGoodsGameboxInducInfo = () => {
  if (!uni.$data.session.openGoodsGameboxInducInfo) {
    uni.$data.session.openGoodsGameboxInducInfo = getSession('openGoodsGameboxInducInfo');
  }

  return uni.$data.session.openGoodsGameboxInducInfo;
};
export const setOpenGoodsGameboxInducInfo = openGoodsGameboxInducInfo => {
  uni.$data.session.openGoodsGameboxInducInfo = openGoodsGameboxInducInfo;
  setSession('openGoodsGameboxInducInfo', openGoodsGameboxInducInfo);
};